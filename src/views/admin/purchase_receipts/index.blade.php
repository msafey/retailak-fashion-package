...
@component('layouts.admin.breadcrumb')
 ...
 <div class="row">
                ...
                <!-- Add Company Button -->
                  <a href="{{url('/admin/purchase-receipts/create?purchase_order_id='.$purchase_order_id)}}" class="btn btn-rounded btn-primary"><i
                            class="zmdi zmdi-plus-circle-o"></i>Purchase New Receipt</a>
...
<script>
    ...
    <?php $listUrl = url('admin/purchaseReceiptsList').'/'.$purchase_order_id;;?>
