...
@component('layouts.admin.breadcrumb')
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12 card card-block">
                    ...
                    {!! Form::open(['url' => ['/admin/permissions', $permission->id],'method'=>'PATCH', 'id'=>'form','files' => true, 'data-parsley-validate'=>'']) !!}
  <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12 ">
            <br>
                <div class="col-sm-6">
                    <label for="name" class="">Name :<span style="color:red;">*</span></label>
                    <input name="name" value="{{$permission->name}}" type="text" style=""  placeholder="Title" class="form-control" id="name" placeholder="" required="required" data-parsley-maxlength="150"/>
                </div>
        </div>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
            <br>
                <div class="col-sm-6">
                    ...
                    <input name="display_name" value="{{$permission->display_name}}" type="text" style=""  placeholder="Display Name" class="form-control" id="display_name" placeholder="" required="required" data-parsley-maxlength="150"/>
