                ...
                <div class="row">
                    ...
                    <div class="card card-block">
                        <div class="card-title">
                            ...
                            <!-- Add menu Button -->
                            <a href="{{url('/admin/permissions/create')}}" class="btn btn-rounded btn-primary"><i
                                        class="zmdi zmdi-plus-circle-o"></i> Add New Permission </a>
                            <!-- Add menu Button End-->
...
<script>
            ...
            <?php $deleteurl = url('/admin/permissions/delete'); ?>
            <?php $editurl = url('/admin/permissions/');?>

        var table = $('#items_datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('permissionsList') !!}',
                columns: [
                    {data:'name', name: 'name'},
