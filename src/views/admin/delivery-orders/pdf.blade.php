                           ...
                           <div class="row section-break">
                                   <div class="col-xs-12 column-break">
                                       ...
                                       <div data-fieldname="items" data-fieldtype="Table">
                                           <table id="header" class="table" border="0" >
                                               <thead>
                                                   <tr>
                                                       
                                                       
                                                           <th style="width: 60px;" class="" data-fieldname="items" data-fieldtype="Table">
                                                               Customer Name</th>
                                    ...
                                    <table id="header" class="table" border="0" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 60px;" class="" data-fieldname="items" data-fieldtype="Table">
                                                            Promocode Discount Name</th>
                                                <th style="width: 60px;" class="" data-fieldname="items" data-fieldtype="Table">
                                                            Final Total After Discount</th>
                                                @endif
                                                <th style="width: 60px;" class="text-right" data-fieldname="items" data-fieldtype="Table">Date</th>         
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>       
