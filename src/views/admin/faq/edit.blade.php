            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to Delete Question</h5>
          ...
          <div style="padding: 25px;">
            <form method="post" action="{{ route('updateFAQ') }}">
              ...
              <div class="col-12">
                ...
                <input required name="title" class="col-xs-9 form-control" type="text" placeholder="FAQ Header.... " class="form-control" value="{{ $faq->title }}">
              </div>
              ...
              <div class="details">
                <p style="text-align: center;padding: 10px;" class="bg-inverse">Question & Answers <i onclick="add_detail()" class="fas fa-lg fa-plus-square" style="float: right;color: #fff;font-size: 30px;cursor: pointer;"></i> </p>
                  ...
                  @foreach($faq->details as $detail)
                    <input type="hidden" name="detail_key[]" value="{{$detail->id}}">
                      <div class="detail  detail{{$detail->id}}">
                        <div class="col-12 question">
                          <label class="col-xs-12">Question ? <i onclick="deleteDetail({{ $detail->id }})" class="fas fa-lg fa-minus-square" style="float: right;color: #06060638;font-size: 30px;cursor: pointer;"></i> </label>
                          <input required name="question[]" class="col-xs-9 form-control" type="text" placeholder="Question.... " class="form-control" value="{{$detail->question}}">
                          </div>
                          <div class="clearfix" style="margin-bottom: 3px;"></div>
                          <div class="col-12 answer" >
                            <textarea required name="Answer[]" class="col-xs-9 form-control" type="text" placeholder="Answer.... " class="form-control" >{{$detail->answer}}</textarea>
                          </div>
                      </div>
              ...
              <button class="btn btn-dark" style="position:relative;">update FAQ</button>
            </form>
          </div>
...
<script>
    function add_detail()
    {
        $('.details').append(' <div class="detail">\n' +
            '<input type="hidden" name="detail_key[]" value="-10">\n' +
            '<div class="col-12 question">\n' +
