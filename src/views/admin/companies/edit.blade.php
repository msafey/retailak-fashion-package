...
<!-- Left Sidebar End -->
 ...
 @component('layouts.admin.breadcrumb')
        ...
        {!! Form::open(['url' => ['/admin/companies', $company->id],'method'=>'PATCH', 'id'=>'form','files' => true, 'data-parsley-validate'=>'']) !!}
                     ...
                     <div style="margin-left: 5px" class="card-text">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px">
                                            <div class='input-group date' style="display: inline;" id='datetimepicker1'>
                                                <input type='text' value="{{$company->name_en}}" required name="name_en" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px; float:right; text-align: right">
                                            <div class='input-group date' id='datetimepicker1' style="display: inline;  text-align: right;direction: rtl">
                                                <input type='text' required name="name" value="{{$company->name}}" class="form-control">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px">
                                            <div class='input-group date' style="display: inline;" id='datetimepicker1'>
                                            <textarea class="form-control"  id="" name="description_en" rows="3">{{$company->description_en}}</textarea>                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="col-lg-12" style="float: right; text-align: right">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px; float:right; text-align: right">
                                            ...
                                            <textarea class="form-control" dir="rtl" id="" name="description" rows="3">{{$company->description}}</textarea>                                            </div>
                                        </div>
                                    </div>
                             ...
                             <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12 ">
                                     ...
                                     <div class="col-md-3 "">
                                         ...
                                         @if(isset($company->logo))
                                             <img style="height: 150px;width: 200px;object-fit: contain;" id="img" src="{{$company->imgThumbPath($company->logo)}}?{{rand(1, 3000)}}" />
                                         @else
