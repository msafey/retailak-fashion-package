...
@component('layouts.admin.breadcrumb')
        ...
        {!! Form::open(['url' => ['/admin/supplier-types', $supplier_type->id],'method'=>'PATCH', 'id'=>'form','files' => true, 'data-parsley-validate'=>'']) !!}
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-6" style="margin-top: 0px">
                                            <div class='input-group date' style="display: inline;" id='datetimepicker1'>
                                                <input type='text' value="{{$supplier_type->name}}" required name="name" class="form-control">
                                            </div>
                                        </div>
                                    </div>
