...
@component('layouts.admin.breadcrumb')
                ...
                <!-- Add Company Button -->
                <a href="{{url('/admin/productPackages/create')}}" class="btn btn-rounded btn-primary"><i
                            class="zmdi zmdi-plus-circle-o"></i> Add New Package</a>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Are you Sure That You Want To Delete This Package ?
                        </div>
...
<script>
 ...
 <?php $editurl = url('/admin/productPackages/');?>
 <?php $deleteurl = url('/admin/productPackages/delete');?>

 var table = $('#items_datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('productPackagesList') !!}',
        columns: [
