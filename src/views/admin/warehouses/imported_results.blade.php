...
@component('layouts.admin.breadcrumb')
            ...
            <div class="row">
              <div class="card card-block">
                                 ...
                                 <ul style="width: 100%;margin-bottom: 50px;" id="sortable1" class="connectedSortable">
                                      <li style="background-color:white">  
                                       ...
                                       @foreach($insufficient as $k => $error) 
                                          <li style="background-color: #f5f0f0;">
                                            <div class="col-sm-2" >  
                                             <b>   {{$k}} </b>
                                            </div>
                                            <div class="col-sm-3">
                              ...
                              <div class="col-md-6">  
                                 <ul style="width: 100%;margin-bottom: 50px;" id="sortable1" class="connectedSortable">
                                      <li style="background-color:white">  
                                       ...
                                       @foreach($sufficient as $k => $success) 
                                          <li style="background-color: #f5f0f0;">
                                            <div class="col-sm-2" >  
                                             <b>   {{$k}} </b>
                                            </div>
                                            ...
                                            <div class="col-sm-7"  >  
                                               <p style="color: green;"><b>  {{$success['success']}}</b></p>
                                            </div>
                ...
                <a href="{{url('admin/importStocks')}}" class="btn btn-primary">Back To Import</a>
                <a href="{{url('admin/warehouses')}}" class="btn btn-secondary">Back To Warehouses</a>
              </div>
            </div>
        </div>
    </div>
