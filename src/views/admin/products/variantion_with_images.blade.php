 	        ...
 	        @endforeach
 	        	<div class="col-lg-6" style="margin-top: 10px;">
 	        	  <div class='input-group date' style="display: inline;" id=''>
 	        	    ...
 	        	    </label>                                                      <input type="text" required="" class="form-control variant_price" value="{{$price}}" name="variation_price1">
 	        	  </div>
 	        	</div>
 	        	<div class="col-lg-6" style="margin-top: 10px;">
 	        	  ...
 	        	  <div class='input-group date' style="display: inline;" id=''>
 	        	      <input type="text" class="form-control variant_cost" value="{{$cost}}" name="variation_cost1">
 	        	  </div>
 	        	</div>
 	    </div>
 	</div>
