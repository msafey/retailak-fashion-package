                                          ...
                                          @foreach($attribute_array as $attr)
                                            <div class="row DateRow" id="field{{$i}}" style="margin-left: 20px;margin-top: 10px">
                                                <div class="col-sm-4" >
                                                    ...
                                                    <select required name="attributes_keys[]" id="key{{$i}}" class="form-control attribute_keys" >
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <select required name="attributes_value[]" id="value{{$i}}" class="form-control attributes_value" >
