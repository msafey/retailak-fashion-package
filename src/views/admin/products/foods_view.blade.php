<div id="all_foods_options">
            ...
            @forelse($foods_array as $key=>$array)
                ...
                <div class="col-lg-12 card card-block multiSizeRow" id="multi_size{{$i}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" style="">
                            <select name="size[]" id="multi_size_{{$i}}" class="form-control multi_size">
                                ...
                                <option value="medium" @if($array['product']->name_en == "medium")selected @endif>
                                    Medium
                                </option>
                    ...
                    @foreach($array['extras'] as $extra)
                        <div class="row multiSizeExtraRow1" id="multisize{{$i}}_{{$j}}">
                            <div class="col-md-1">
                                <label style="margin-bottom: 0;" class="form-group" for="from">
                                    Extras
                                </label>
    ...
    <div class="row col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12 "
         style="margin-bottom: 10px;">
        <div class="col-lg-1">
            <input type="radio" value="options" class="food_types" id="option_type"
                   @if(isset($produt) && $product->food_type=='options')checked
                   @endif name="food_type">
        </div>
        ...
        @if(isset($product) && $product->food_type=='options')
            ...
            @forelse($foods_array as $key => $array)
                <div class="col-lg-12 card card-block optionRow" id="type_option{{$i}}"
                    ...
                    <?php $j = 1; ?>
                    @foreach($array['extras'] as $arr)
                        <div class="row optionExtraRow" id="option{{$i}}_{{$j}}">
                            <div class="col-md-1">
                                <label style="margin-bottom: 0;" class="form-group" for="from">
                                    Extras
                                </label>
...
<script>
    ...
    var extra_element = '<div class="row multiSizeExtraRow1" id="multisize1_1">' +
        ...
        '</div>' +
        '<div class="col-md-2" style=" ">' +
        '<select name="multi_size_extra_id[]" class="form-control multi_extra"  id="multi_size_extra1_1">' +
        '<option value="">All</option>' +
        '<option value="1">Extra</option>' +
        '<option value="2">Extra</option>' +
        '<option value="3">Extra</option>' +
    ...
    $(document).on('change', '.multi_size', function (e) {
        ...
        $('.multiSizeExtraRow' + attr_num).each(function () {
            ...
            $('.multiSizeRow' + attr_num + ' #multi_size_note' + attr_num).attr("name", 'multi_size_note-' + value);
    ...
    $(document).on('click', '.add_one_size_extra', function () {
        ...
        if (one_size_value == null || one_size_value == '' || one_size_price == null || one_size_price == '') {
            ...
            $('#onesize' + cTypeIncrementNum + ' #one_size_unchecked_optional' + attr_num).attr('id', 'one_size_checked_optional' + cTypeIncrementNum);
