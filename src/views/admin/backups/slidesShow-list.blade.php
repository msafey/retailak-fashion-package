                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            <h4 class="m-t-0 header-title"><b> slidesShow Items</b></h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                @if(isset($slideShowItems))
                                                    @foreach($slideShowItems as  $item)
                                                        <tr>
                                                            <td>{{$item->data->name}}</td>
                                                            <td>{{$item->data->doctype}}</td>
                                                            <td>{{$item->data->owner}}</td>
                                                            <td>{{$item->data->modified_by}}</td>
                                                            <td>
                                                                @foreach($item->data->slideshow_items as $slideItem)
                                                                    {{$slideItem->image}}
                                                                @endforeach
                                                            </td>
                                                        </tr>
