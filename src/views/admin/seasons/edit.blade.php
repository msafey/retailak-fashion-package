...
<!-- Left Sidebar End -->
    ...
    <div class="content-page">
        ...
        {!! Form::open(['url' => ['/admin/seasons', $season->id],'method'=>'PATCH', 'id'=>'form','files' => true, 'data-parsley-validate'=>'']) !!}
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px">
                                            <div class='input-group date' style="display: inline;" id='datetimepicker1'>
                                                <input type='text' value="{{ $season->name_en }} " required name="name_en" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12" style="margin-top: 0px; float:right; text-align: right">
                                            <div class='input-group date' id='datetimepicker1' style="display: inline; direction:rtl; text-align: right;">
                                                <input type='text' required name="name" value="{{ $season->name }}" class="form-control">
                                            </div>
                                        </div>   
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                     <div class="col-lg-6">
                                         ...
                                         <div class="col-lg-12" style="margin-top: 0px">
                                             <div class='input-group date' style="display: inline;" id='datetimepicker1'>
                                             <textarea class="form-control"  id="" name="description_en" rows="3">{{ $season->description_en }}</textarea>                                            </div>
                                         </div>
                                     </div>
                                     <div class="col-lg-6">
                                         <div class="col-lg-12" style="float: right; text-align: right">
                                         ...
                                         <div class="col-lg-12" style="margin-top: 0px; float:right; text-align: right">
                                             <div class='input-group date' id='datetimepicker1' style="display: inline;  text-align: right">
                                                 <textarea class="form-control" dir="rtl" id="" name="description" rows="3">{{ $season->description }}</textarea>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
