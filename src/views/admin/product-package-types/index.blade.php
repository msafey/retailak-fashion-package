...
@component('layouts.admin.breadcrumb')
                ...
                <!-- Add Company Button -->
                <a href="{{url('/admin/productPackagetypes/create')}}" class="btn btn-rounded btn-primary"><i
                            class="zmdi zmdi-plus-circle-o"></i> Add New Package Type</a>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Are you Sure That You Want To Delete This Package Type ?
                        </div>
...
<script>
 ...
 <?php $editurl = url('/admin/productPackagetypes/');?>
 <?php $deleteurl = url('/admin/productPackagetypes/delete');?>

 var table = $('#items_datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('productPackageTypesList') !!}',
        columns: [
