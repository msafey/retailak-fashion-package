                ...
                <div class="row">
                    ...
                    <div class="card card-block">
                        <div class="card-title">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="" style="margin-right: 50px;">Filters:</label><input type="checkbox"
                                                                                                     checked
                                                                                                     name="active"
                                                                                                     value="1"
                                                                                                     id="active">Show
                                    Active Categories &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="inactive"
                                                                                     value="" id="inactive">Show
                                    Inactive Categories
                                </div>
        ...
        columns: [
            ...
            {data: 'parent_item_group', name: 'parent_item_group'},
            {
                data: 'image', searchable: false, render: function (image, type, row) {
                    return "<img class='img-data-tables' height='100px;' width='150px' style='object-fit: contain' " +
                        "src='{{url('/public/imgs/categories')}}" + '/' + image + "'>"
                }
            },
