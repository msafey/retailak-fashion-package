...
<!-- Left Sidebar End -->
 ...
 @component('layouts.admin.breadcrumb')
            ...
            <!--End Bread Crumb And Title Section -->
                ...
                <!-- Add Company Button -->
                <a href="{{url('/admin/uom/create')}}" class="btn btn-rounded btn-primary"><i
                            class="zmdi zmdi-plus-circle-o"></i> Add New Unit Of Measure</a>
...
<script>
 ...
 <?php $editurl = url('/admin/uom/');?>
 <?php $deleteurl = url('/admin/uom/delete'); ?>
 ...
 var table = $('#items_datatable').DataTable({
        ...
        columns: [
             {data:'type',name:'type'},
                ...
                {
                    return "<a href='{{$editurl}}" + '/' + data + '/edit' + "' class='btn btn-primary'><i class='fas fa-edit' data-toggle='tooltip' data-placement='top' title='Edit UOM' ></i></a>&nbsp;<button data-toggle='modal' data-target='#deleteModal' onclick='deleteItem(" + data + ", " + 1 + ")' type='button' class='btn btn-danger' title='Delete UOM'><i class='fa fa-trash' data-toggle='tooltip' data-placement='top' title='Delete UOM' ></i></button>";
