...
@component('layouts.admin.breadcrumb')
                ...
                <div class="card card-block">
                    <div style="margin-left: 5px" class="card-head">
                        <h1>Import Products - Results</h1>
                    </div>
                     <div style="margin-left: 5px; margin-top:20px;" class="card-text">
                        <div class="row">
                            @foreach($allArrays['issuesArray'] as $issue)
                            <div class="alert alert-danger">{{$issue}}</div>
                            @endforeach

                            @foreach($allArrays['successArray'] as $issue)
                            <div class="alert alert-success">{{$issue}}</div>
                            @endforeach
                            <div class="col-sm-10">
