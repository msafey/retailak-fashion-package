...
@component('layouts.admin.breadcrumb')
                ...
                {!! Form::open(['url' => '/admin/import/products/step2/'.$pathNo, 'class'=>'form-hirozontal ','id'=>'imagesForm','files' => true, 'data-parsley-validate'=>'']) !!}

                <div class="card card-block">
                    <div style="margin-left: 5px" class="card-head">
                        <h1>Import Products - Step 2 of 2 - Upload Excel File</h1>
                    </div>
                     <div style="margin-left: 5px; margin-top:20px;" class="card-text">
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="alert alert-success"> The Images File Was Successfully uploaded</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10">
                                <label style="margin-bottom: 0;" class="form-group" for="images">
                                    <b>Upload Product's Excel File </b>
                                </label>
                                 <input type="file" name="excelFile"  id="uploadExcelFile"  class="form-group" >
                            </div>
                      ...
                      <div class="row">
                          <div class="col-sm-10">
                              <button type="submit" id="uploadExcelBtn" class="btn btn-primary">Upload File</button>
                          </div>
                      </div>
