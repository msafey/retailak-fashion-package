                              ...
                              <div class="col-sm-12" >
                                  <div class='input-group date' id='' style="display: inline;">
                                      <select  name="second_item_group" id="second_item_group" class="form-control select2" >
                                        <option value="" disabled  selected="">Second Item Group</option>
                                         @foreach($parent_category as $key=> $category)
                                        <optgroup label="{{$key}}">
                                            @foreach($category as $cat)
                          ...
                          <div class="col-lg-6">
                              ...
                              <div class="col-lg-12" style="margin-top: 0px">
                                  <div class='input-group' style="display: inline;" id=''>
                                      <input type="text" required="" value="{{$price}}" class="form-control" id="standard_rate" name="standard_rate">
                                  </div>
                              </div>
                          </div>
                          <div class="col-lg-6">
                              ...
                              <div class="col-lg-12" style="margin-top: 0px;">
                                  <div class='input-group date' id='' style="display: inline;  text-align: right">
                                      <input type="text" value="{{$cost}}" id="cost" required="" class="form-control" name="cost">
                                  </div>
                              </div>
                          </div>
                      </div>
                              ...
                              <div class="col-lg-12" style="margin-top: 0px;">
                                  <div class='input-group date' id='' style="display: inline;  text-align: right">
                                      <select name="season_id" class="form-control">
                                          ...
                                          <option @if($product->season_id == $season->id)selected @endif value="{{$season->id}}">{{$season->name_en}}</option>
                                          @endforeach
                                      </select>
                                  </div>
                              </div>
                      ...
                      <div class="row">
                        ...
                        @if(checkProductConfig('foods'))
                              <div class="col-lg-2">
                                  ...
                                  <div class="col-lg-12" style="margin-top: 0px">
                                      <label class="switch">
                                          <input type="checkbox" value="1" id="is_extra" @if($product->is_food_extras == 1)checked @endif name="is_food_extras">
                                          <span class="slider round"></span>
                                      </label>
                                  </div>
                              </div>
                               <div class="col-lg-3" id="extra_price" @if($product->is_food_extras != 1)style="display: none;" @endif>
                                  <div class="col-lg-12">
                                      <label style="margin-bottom: 0;" class="form-group" for="from">Extra Price
                                      </label>
                                  </div>
                                  <div class="col-lg-12" style="margin-top: 0px">
                                          <input type="text" value="{{$product->standard_rate}}" id="extra_price_input"  class="form-control" name="extra_price">
                                  </div>
                              </div>
                                              ...
                                              <div class="col-lg-12" style="margin-top: 0px">
                                                ...
                                                <!-- </div> -->
                                                  ...
                                                  <div class="col-lg-6" style="margin-top: 10px;">
                                                    <div class='input-group date' style="display: inline;" id=''>
                                                      <label style="margin-bottom: 0;" class="form-group" for="from">Price: <span style="color:red;">*</span>
                                                      </label>                                                      <input type="text" required="" class="form-control " value="{{$variant_data->price}}" name="variation_price{{$i}}">
                                                    </div>
                                                  </div>
                                                  <div class="col-lg-6" style="margin-top: 10px;">
                                                    <label style="margin-bottom: 0;" class="form-group" for="from">Cost: <span style="color:red;">*</span>
                                                    </label>
                                                    <div class='input-group date' style="display: inline;" id=''>
                                                        <input type="text" class="form-control " value="{{$variant_data->cost}}" name="variation_cost{{$i}}">
                                                    </div>
                                                  </div>
...
<script type="text/javascript">
 ...
 $('#has_attributes').on('change',function(){
    ...
    var count_variation_data = '<?php echo count($variations_data); ?>';
    $(document).on('click','#variant_added',function(e){
     ...
     selected_variations.clean(undefined);
            $.ajax({
              ...
              data: {'selected_variations' : selected_variations,'cost':cost,'price':standard_rate},
              success: function(response){
                if(response =='false'){
                ...
                if(!div_exist){
                    ...
                    $('#variations_data .card-block:last #variation_price1').attr('id','variation_price' + cTypeIncrementNum);
                    $('#variations_data .card-block:last #variation_cost1').attr('id','variation_cost' + cTypeIncrementNum);
