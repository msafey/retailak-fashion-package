                ...
                @include('layouts.admin.errorMsg')
                    <div class="card card-block">
                        <div class="card-title">
                            <a href="{{url('/admin/products/create')}}" class="btn btn-rounded btn-primary"><i class="zmdi zmdi-plus-circle-o"></i> Add New Product</a>
                            <div class="col-sm-3">
                            ...
                            <a href="#" id="order2" class="btn btn-rounded btn-primary"><i class="zmdi zmdi-plus-circle-o"></i>Order Of Products According To Category</a>
                            <a href="{{url('admin/product/reordering')}}" id="order3"
                               class="btn btn-rounded btn-primary"><i class="zmdi zmdi-plus-circle-o"></i> Products
                                ...
                                <a href="{{url('admin/import/products/step1')}}" id="order3" class="btn btn-rounded btn-primary"><i class="zmdi zmdi-plus-circle-o"></i> Import Products From Excel</a>

                                <a href="{{url('admin/importStocks')}}"  class="btn btn-rounded btn-primary"><i class="zmdi zmdi-plus-circle-o"></i> Import Stock</a>
                            ...
                            <div class="row" style="margin-left:8px;margin-top: 10px; ">
                                ...
                                <div class="col-sm-3">
                                    <input type="checkbox" name="food_extras" value="1" id="food_extras">Show Extra Products
                                </div>
                                @endif
                            </div>
                        </div>
